...
const QuestSchema = z.object({
  ...
  icon: z.enum(["Twitter", "Users", "Star", "Gem", "MessageSquareQuote"]).describe("The icon for the quest. Choose one from the list."),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a game designer for a meme token project called Meme Token Mania.

Generate a list of 5 creative and engaging quests for the user to complete. The quests should be related to social media engagement, community participation, and using the platform.

Keep the tone lighthearted and witty, in line with the meme theme. Ensure the quests are simple to understand and the rewards are appropriate.
The available icons are: "Twitter", "Users", "Star", "Gem", "MessageSquareQuote".
`,
});
